class Usuario{
    ...
    //los get son el formato final del cual se pretende entregar
    get id(){
        return this._id;
    ...
    get nombre(){
        return this._nombre;//return this._nombre.toUpperCase(); //pura mayuscula
    }
    ...
    //obejto que se pasara a constructor
    /*var data={
        id:100,
        nombre:"Daniel",
        usuario: "Snorlax",
